...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        const bakimmodu = new EmbedBuilder()
            ...
            .setDescription(`Herhangi bir sorunuz vs. varsa <@757252117466710078>'e ulaşınız!`);

        if (db.fetch(`bakim`)) {
            if (interaction.user.id !== "757252117466710078") { return interaction.reply({ embeds: [bakimmodu]}) }
        }
